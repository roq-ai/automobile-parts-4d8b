...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['sales-representative', 'customer-service-representative', 'business-owner'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Parts', path: '/parts', entity: 'part', service: AccessServiceEnum.PROJECT, icon: FiPackage },
