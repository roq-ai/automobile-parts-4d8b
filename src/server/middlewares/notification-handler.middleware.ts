...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'part.update': {
    roles: ['sales-representative', 'customer-service-representative', 'business-owner'],
    key: 'part-out-of-stock',
    tenantPath: ['supplier', 'part'],
    userPath: [],
  },
  'part.create': {
    roles: ['sales-representative', 'customer-service-representative', 'business-owner'],
...
const ownerRoles: string[] = ['sales-representative'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['sales-representative', 'customer-service-representative', 'business-owner'];
