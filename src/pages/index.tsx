...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Automobile Parts Manufacturing`}</title>

        <meta
          name="description"
          content="Welcome to Automobile Parts Manufacturing: Delivering a world of auto and body parts from 100+ manufacturers at warehouse prices. Simplifying the manufacturing of all types of automobiles."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhdXRvJTIwcGFydHN8ZW58MHx8fHwxNjk0NDk3MDA0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Automobile Parts Manufacturing: Delivering a world of auto and body parts from 100+ manufacturers at warehouse prices. Simplifying the manufacturing of all types of automobiles.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Sales Representative"
